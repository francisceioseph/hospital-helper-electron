...
export function getDecoratorManager(decorator, values) {
  return {
    birthDateDecorator            : getDateTimeRequiredDecorator('profile.personal_datum.full_name', decorator, values),
    fullNameDecorator             : getRequiredDecorator('profile.personal_datum.cpf', decorator, values),
    cpfDecorator                  : getRequiredDecorator('profile.personal_datum.gender', decorator, values),
    genderDecorator               : getOptionalDecorator('profile.personal_datum.date_of_birth', decorator, values),
