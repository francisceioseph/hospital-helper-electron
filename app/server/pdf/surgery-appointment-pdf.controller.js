...
const createSurgeryAppointmentReceiptPDF = (event, appointment) => {
  const document = {
    content: [
      {
      ...
      {
        text      : 'Comprovante de Agendamento de Cirurgia',
        style     : 'headerMargin',
        id        : 'header2',
        alignment : 'center',
      },
...
module.exports = { createSurgeryAppointmentReceiptPDF };
