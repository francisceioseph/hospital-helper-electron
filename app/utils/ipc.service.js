...
import {
  ...
  POST_SURGERY_TYPES_CHANNEL,
  POST_SURGERY_TYPES_RESPONSE_CHANNEL,
  UPDATE_SURGERY_TYPES_CHANNEL,
  UPDATE_SURGERY_TYPES_RESPONSE_CHANNEL,
...
export const updatePacient = (id, data) =>
  ipc.sendOnce(UPDATE_PACIENT_CHANNEL, UPDATE_PACIENT_RESPONSE_CHANNEL, { id, data });
...
export const updateDoctor = (id, data) =>
  ipc.sendOnce(UPDATE_DOCTOR_CHANNEL, UPDATE_DOCTOR_RESPONSE_CHANNEL, { id, data });
...
export const getAppointmentTypes = () =>
  ipc.sendOnce(GET_APPOINTMENT_TYPES_CHANNEL, GET_APPOINTMENT_TYPES_RESPONSE_CHANNEL);
export const createAppointmentType = data =>
  ipc.sendOnce(POST_APPOINTMENT_TYPE_CHANNEL, POST_APPOINTMENT_TYPE_RESPONSE_CHANNEL, { data });
export const updateAppointmentType = (id, data) =>
  ipc.sendOnce(UPDATE_APPOINTMENT_TYPE_CHANNEL, UPDATE_APPOINTMENT_TYPE_RESPONSE_CHANNEL, { id, data });
export const removeAppointmentType = id =>
  ipc.sendOnce(REMOVE_APPOINTMENT_TYPE_CHANNEL, REMOVE_APPOINTMENT_TYPE_RESPONSE_CHANNEL, { id });
...
export const getAppointments = doctorId =>
  ipc.sendOnce(GET_DOCTOR_APPOINTMENTS_CHANNEL, GET_DOCTOR_APPOINTMENTS_CHANNEL, { doctorId });
export const createAppointment = data => ipc.sendOnce(POST_APPOINTMENT_CHANNEL, { data });
export const updateAppointment = (id, data) =>
  ipc.sendOnce(UPDATE_APPOINTMENT_CHANNEL, UPDATE_APPOINTMENT_RESPONSE_CHANNEL, { id, data });
export const removeAppointment = id =>
  ipc.sendOnce(REMOVE_APPOINTMENT_CHANNEL, REMOVE_APPOINTMENT_RESPONSE_CHANNEL, { id });
...
export const updateSpecialty = (id, data) =>
  ipc.sendOnce(UPDATE_SPECIALTY_CHANNEL, UPDATE_SPECIALTY_RESPONSE_CHANNEL, { id, data });
...
export const createExamType = data => ipc.sendOnce(POST_EXAM_TYPES_CHANNEL, POST_EXAM_TYPES_RESPONSE_CHANNEL, { data });
export const updateExamType = (id, data) =>
  ipc.sendOnce(UPDATE_EXAM_TYPE_CHANNEL, UPDATE_EXAM_TYPE_RESPONSE_CHANNEL, { id, data });
...
export const getExams = examTypeId =>
  ipc.sendOnce(GET_EXAMS_FOR_TYPE_CHANNEL, GET_EXAMS_FOR_TYPE_RESPONSE_CHANNEL, { examTypeId });
...
export const getSurgeryTypes = id =>
  ipc.sendOnce(GET_SURGERY_TYPES_CHANNEL, GET_SURGERY_TYPES_RESPONSE_CHANNEL, { id });
export const createSurgeryType = data =>
  ipc.sendOnce(POST_SURGERY_TYPES_CHANNEL, POST_SURGERY_TYPES_RESPONSE_CHANNEL, { data });
export const updateSurgeryType = (id, data) =>
  ipc.sendOnce(UPDATE_SURGERY_TYPES_CHANNEL, UPDATE_SURGERY_TYPES_RESPONSE_CHANNEL, { id, data });
export const removeSurgeryType = id =>
  ipc.sendOnce(REMOVE_SURGERY_TYPE_CHANNEL, REMOVE_SURGERY_TYPE_RESPONSE_CHANNEL, { id });

export const getSurgery = id => ipc.sendOnce(GET_SURGERY_CHANNEL, GET_SURGERY_RESPONSE_CHANNEL, { id });
export const getSurgeries = doctorId =>
  ipc.sendOnce(GET_SURGERIES_BY_DOCTOR_CHANNEL, GET_SURGERIES_BY_DOCTOR_RESPONSE_CHANNEL, { doctorId });
...
export const updateSurgery = (id, data) =>
  ipc.sendOnce(UPDATE_SURGERY_CHANNEL, UPDATE_SURGERY_RESPONSE_CHANNEL, { id, data });
export const removeSurgery = id =>
  ipc.sendOnce(REMOVE_APPOINTMENT_CHANNEL, REMOVE_APPOINTMENT_RESPONSE_CHANNEL, { id });
