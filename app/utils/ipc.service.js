...
export const createSurgeryType = data => ipc.sendOnce(POST_SURGERY_TYPES_CHANNEL, POST_SURGERY_TYPES_RESPONSE_CHANNEL, { data });
export const updateSurgeryType = (id, data) => ipc.sendOnce(UPDATE_SURGERY_TYPES_CHANNEL, UPDATE_SURGERY_TYPES_RESPONSE_CHANNEL, { id, data });
