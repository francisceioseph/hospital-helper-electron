...
export const getAppointments = doctorId => http.getRequest(http.getAppointmentsUrl(doctorId));
...
export const updateExamType = (id, data) => http.patchRequest(http.updateExamTypeUrl(id), makePayload('exam_type', data));
...
export const updateSurgeryType = (id, data) => http.patchRequest(http.removeExamTypeUrl(id), makePayload('surgery_type', data));
